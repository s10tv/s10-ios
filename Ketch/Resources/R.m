...
const struct R R = {
    ...
    .Strings = {
        ...
        .permLocationExplanation = @"PermLocationExplanation",
        .permNotificationsButtonTitle = @"PermNotificationsButtonTitle",
        .permNotificationsExplanation = @"PermNotificationsExplanation",
